...
const SAVINGS_VAULT_ABI = [
  ...
  'function getCurrentYearNAVSummary() view returns (uint256 totalIncrease, uint256 averageIncrease, uint256 maxIncrease, uint256 minIncrease, uint256 recordCount)',
...
const WRAP_MANAGER_ABI = [
  ...
  'function getConfiguration() view returns (address, address, address, address, uint256, uint256, uint256, uint256, uint256, uint256)',
